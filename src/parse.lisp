...
(defun parse-common-line (line rcv)
  (cond ((string-prefix-p "# " line) (apply rcv `((:h1 ,(subseq line 2)))))
        ((string-prefix-p "## " line) (apply rcv `((:h2 ,(subseq line 3)))))
        ((string-prefix-p "### " line) (apply rcv `((:h3 ,(subseq line 4)))))
        ((string-prefix-p "#### " line) (apply rcv `((:h4 ,(subseq line 5)))))
        ((string-prefix-p "##### " line) (apply rcv `((:h5 ,(subseq line 6)))))
        ((string-prefix-p "###### " line) (apply rcv `((:h6 ,(subseq line 7)))))
        ((string-prefix-p "####### " line) (apply rcv `((:h7 ,(subseq line 8)))))
